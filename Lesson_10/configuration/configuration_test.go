...
var testFiles = []testFile{
	...
	{
		"config_test.yaml", "use_cache: true\nurl: \"https://google.com\"",
	},
	{
		"config_test.env", "USE_CACHE=true\nEXTERNAL_URL=http://yandex.ru",
	},
}
...
func TestLoadOk(t *testing.T) {
	...
	var tests = []struct {
		...
		{"config_test.json", &Config{UseCache: true, Url: "https://gb.ru"}, nil},
		{"config_test.yaml", &Config{UseCache: true, Url: "https://google.com"}, nil},
		{"config_test.env", &Config{UseCache: true, Url: "http://yandex.ru"}, nil},
	}
